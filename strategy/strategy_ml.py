...
class MLStrategy(StrategyBase):
    ...
    def prepare_features(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        # Rimuovi righe con valori NaN dopo le trasformazioni
        df = df.dropna()
